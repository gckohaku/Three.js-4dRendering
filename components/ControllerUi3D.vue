...
const rotateX = defineModel<number | string>("rotateX", { required: true });
const rotateY = defineModel<number | string>("rotateY", { required: true });
const rotateZ = defineModel<number | string>("rotateZ", { required: true });
